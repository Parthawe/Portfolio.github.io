...
const routeLabels = new Map([
  ...
  ['motion/mentra-motion-language', 'Mentra — From Mark to Point of View'],
...
const routeDescriptions = new Map([
  ...
  ['motion/mentra-motion-language', 'A modular launch-motion system connecting the shipped Mentra identity, AI glasses, first-person capture, and MentraOS.'],
