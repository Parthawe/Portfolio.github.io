...
export default function UvLightPage() {
  return (
    <>
        ...
        <section className="cs-section reveal" id="cs-discovery">
          <div className="wrap">
            ...
            <CsBody>
              ...
              <p>The research phase drew on principles from environmental psychology and immersive theatre design. We studied how installations like Meow Wolf and Punchdrunk&rsquo;s &ldquo;Sleep No More&rdquo; guide participants through space without explicit instructions, relying instead on environmental cues, curiosity, and social dynamics. The key finding was that discovery-based experiences work best when the hidden content rewards exploration without punishing those who miss it &mdash; every participant should have a meaningful experience, even if they do not find every hidden message.</p>
      ...
      <NextProject slug="revolving-stage" title="Revolving Stage" image="/Assets/images/revolving-stage.jpg" />
      <Footer />
    </>
  )
}
