      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#6b7280' } as React.CSSProperties}>
        ...
        <CsSection id="cs-thread" label="02 &mdash; The Thread" title="Making the Invisible Tangible">
          <CsBody>
            ...
            <p><a href="/enigma" className="project-text-link">Enigma</a> turns neural-network computation into cascading light. <a href="/sea-of-salt" className="project-text-link">Why the Sea is Salt</a> turns narrative consequence into grinding salt. <a href="/zentipay" className="project-text-link">ZentiPay</a> turns hidden fees into visible trust. <a href="/shuffle" className="project-text-link">Shuffle</a> turns tradeoffs into weighted tokens. <a href="/jugalbandi" className="project-text-link">Jugalbandi</a> turns inference into sound.</p>
        ...
        <CsSection id="cs-method" label="03 &mdash; The Method" title="Medium as Meaning">
          <CsBody>
            ...
            <p>Neural networks become light because activation should be visible. Stories become salt because narrative accumulates. Watches make time mechanical. The <a href="/moniac-machine" className="project-text-link">MONIAC</a> makes money flow as water.</p>
        ...
        <CsSection id="cs-tension" label="04 &mdash; The Tension" title="Rigor vs. Imagination">
          <CsBody>
            ...
            <p>The tension is the practice. <a href="/mentra" className="project-text-link">Mentra</a> needs both because real-world interruptions have safety implications. <a href="/the-omakase" className="project-text-link">The Omakase</a> needs both because a playful cabinet still has to feel fair.</p>
          </CsBody>
        </CsSection>
