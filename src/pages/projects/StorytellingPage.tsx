...
export default function StorytellingPage() {
  return (
    <>
      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#8b5e3c' } as React.CSSProperties}>
        ...
        <CsSection id="cs-frameworks" label="02 &mdash; Frameworks" title="Narrative Structures in Design">
          <CsFeatureGrid features={[
            { title: 'The Hero\'s Journey in Onboarding', desc: 'Joseph Campbell\u2019s monomyth maps perfectly to product onboarding: the user starts in their ordinary world (the problem), crosses a threshold (signup), faces trials (learning the interface), and returns transformed (achieving their goal). ZentiPay\u2019s onboarding was redesigned using this framework \u2014 each step explicitly mirrors a narrative beat.' },
      ...
      <NextProject slug="on-becoming" title="On Becoming" image="/Assets/images/sea-of-salt.svg" />
      <Footer />
    </>
  )
}
