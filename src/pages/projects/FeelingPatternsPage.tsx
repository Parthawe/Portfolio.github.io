      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#9c6b8a' } as React.CSSProperties}>
        ...
        <CsSection id="cs-insights" label="03 &mdash; Insights" title="What Touch Teaches">
          <CsBody>
            ...
            <p>This work directly informed how I think about notification design at <a href="/mentra" className="project-text-link">Mentra</a> &mdash; smart glasses that need to communicate without a screen. The haptic patterns I developed in this course became a useful reference for subtle wearable feedback.</p>
          </CsBody>
        </CsSection>
