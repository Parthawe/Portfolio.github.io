    ...
    <>
      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#3A3A3E' } as React.CSSProperties}>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Portfolio.github.io/Assets/Projects/Sculpture/1.jpg" alt="Figurative sculpture — dramatic low-key lighting on plaster figure" loading="eager" />
          </div>
        </section>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Portfolio.github.io/Assets/Projects/Sculpture/3.jpg" alt="Moodboard — anatomical references, classical sculpture studies, medical imaging, and color palette" loading="lazy" />
          </div>
        </section>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Portfolio.github.io/Assets/Projects/Sculpture/4.jpg" alt="Failed ideas and process — early attempts, metal armature construction, and building up the form" loading="lazy" />
          </div>
        </section>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Portfolio.github.io/Assets/Projects/Sculpture/5.jpg" alt="Final sculpture — life-size plaster figure under dramatic lighting, studio and competition display" loading="lazy" />
          </div>
        </section>
