      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#5C7EA8' } as React.CSSProperties}>
        ...
        <CsSection id="cs-digital" label="03 &mdash; Digital" title="Digital">
          <CsBody>
            ...
            <p>This exploration of time continued in <a href="/Portfolio.github.io/black-hole" style={{ color: 'var(--ink)', textDecoration: 'underline', textUnderlineOffset: '3px' }}>Black Hole</a>, where the question shifted from &ldquo;how do we measure time?&rdquo; to &ldquo;what happens when time itself bends?&rdquo; The Black Hole project builds five physical models of gravitational phenomena &mdash; including a time dilation model where clocks slow down near the event horizon.</p>
          </CsBody>
        </CsSection>
