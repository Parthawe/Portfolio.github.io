      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#8B6914' } as React.CSSProperties}>
        ...
        <CsSection id="cs-sundial" label="01 &mdash; Sundial" title="Sundial">
          <CsBody>
            ...
            <p>I constructed the sundial from wood and brass fittings, calibrating the gnomon angle for New York City&rsquo;s latitude. The hour lines were hand-etched based on calculations that account for the equation of time, the slight variation between solar time and clock time caused by Earth&rsquo;s elliptical orbit. Testing the dial outdoors over several weeks revealed how remarkably precise this ancient method can be &mdash; accurate to within a few minutes on clear days.</p>
