    ...
    <>
      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#054ADA' } as React.CSSProperties}>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Assets/Projects/ibm/1.jpg" alt="IBM Cancer Prognosis — Helping To Secure Cancer Research" loading="eager" />
          </div>
        </section>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Assets/Projects/ibm/2.jpg" alt="Project summary — challenges, role, and tools including FHE Toolkit, Homomorphic Encryption, Neural Networks, Python, Java" loading="lazy" />
          </div>
        </section>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Assets/Projects/ibm/3.jpg" alt="Problem statement flow — genomic data through encrypted channel to server, showing vulnerability when data is unencrypted during computation" loading="lazy" />
          </div>
        </section>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Assets/Projects/ibm/4.jpg" alt="System flow — from unencrypted data through FHE encryption, neural network computation on encrypted data, decryption, clustering, and Kaplan-Meier survival curves" loading="lazy" />
          </div>
        </section>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Assets/Projects/ibm/5.jpg" alt="Homomorphic encryption in detail — unencrypted data passes through neural network hidden layers while remaining encrypted, outputting Kaplan-Meier curves" loading="lazy" />
          </div>
        </section>
        ...
        {/* Remaining images */}
        {[6, 7].map(num => (
          <section className="cs-slide reveal" key={num}>
            <div className="wrap">
              <img src={`/Assets/Projects/ibm/${num}.jpg`} alt={`IBM Cancer Prognosis, detailed view ${num}`} loading="lazy" />
            </div>
          </section>
        ))}
