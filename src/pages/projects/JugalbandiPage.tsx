      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#8B4513' } as React.CSSProperties}>
        ...
        <section className="cs-section reveal" id="cs-background">
          <div className="wrap">
            ...
            <CsBody>
              <p>The genesis of this project drew inspiration from the &lsquo;Abacus&rsquo; project undertaken at panGenerator Studio. While the Abacus focused on recognizing digits, Jugalbandi operates on a similar concept but transforms neural network processes into acoustic and electronic sound. The core question driving the work was: what if you could hear a machine think?</p>
