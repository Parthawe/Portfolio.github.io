  ...
  return (
    <>
      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#6B2FA0' } as React.CSSProperties}>
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <img src="/Assets/Projects/VishwaConclave/5.jpg" alt="VishwaConclave Accelerate The Paradigm Shift — campaigns, website, speakers, merch, and musical experience" loading="lazy" />
          </div>
        </section>
