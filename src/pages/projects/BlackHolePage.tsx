  ...
  return (
    <>
      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#1a1a2e' } as React.CSSProperties}>
        ...
        {/* Hero */}
        <CsImage src="/Portfolio.github.io/Assets/Projects/blackhole/time-trap.jpg" alt="The Black Hole's Time Trap, circular platform with clocks at different distances demonstrating time dilation" />
        ...
        <section className="cs-slide reveal">
          <div className="wrap">
            <video src="/Portfolio.github.io/Assets/Projects/blackhole/time-dilation.mp4" autoPlay loop muted playsInline
          ...
          <div style={{ marginTop: 'var(--space-4)' }}>
            {IS_MOBILE ? (
              <div style={{
                ...
                <img src="/Portfolio.github.io/Assets/Projects/blackhole/fabric-of-universe.jpg" alt="Spacetime fabric model" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" />
                <div style={{
        ...
        <CsImage src="/Portfolio.github.io/Assets/Projects/blackhole/fabric-of-universe.jpg" alt="Fabric of the Universe physical model" />
        ...
        <CsImage src="/Portfolio.github.io/Assets/Projects/blackhole/gravitational-lensing.jpg" alt="Gravitational Lensing and Wormholes physical model" />
        ...
        <CsImage src="/Portfolio.github.io/Assets/Projects/blackhole/binary-mergers.jpg" alt="Binary Black Hole Mergers physical model, three stages" />
