...
export default function OrgDashboardPage() {
  return (
    <>
      ...
      <main id="main-content" className="project-main" style={{ '--project-color': '#2D3748' } as React.CSSProperties}>
        ...
        <CsSection id="cs-concept" label="Concept" title="Give Your AI Agents a Brain for Your Company">
          ...
          <div className="cs-slide reveal">
            <img src="/Assets/images/org-dashboard.png" alt="Dashboard overview" loading="lazy" style={{ borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', width: '100%', height: 'auto' }} />
          </div>
      ...
      <NextProject slug="raahi" title="Raahi" image="/Assets/images/raahi.jpg" />
      <Footer />
    </>
  )
}
