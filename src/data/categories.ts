    ...
    moreProjects: [
      [
        ...
        },
        {
          ...
          alt: 'ZentiPay',
          name: 'ZentiPay',
          result: 'Fintech super app from scratch — 30% higher transaction success',
          role: 'Founding Designer · 2025',
          tag: 'FINTECH',
          year: '2025',
          desc: 'Fintech super app from scratch — 30% higher transaction success',
        },
      ],
      [
        {
      ...
      [
        {
          ...
          alt: 'BreakGen',
          name: 'BreakGen',
          result: 'Modular keyboard with generative design',
