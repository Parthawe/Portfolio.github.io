      ...
      [
        {
          ...
          alt: 'TransFi',
          name: 'TransFi',
          result: 'Crypto payment infrastructure, quick glimpse',
          role: 'Lead Product Designer · 2022–23',
          tag: 'WEB3 PAYMENTS',
          year: '2023',
          desc: 'Crypto payment infrastructure, quick glimpse',
        },
        {
          slug: 'zentipay',
          image: '/Portfolio.github.io/Assets/images/nda-cover.svg',
          alt: 'ZentiPay',
          name: 'ZentiPay',
          result: 'Fintech super app from scratch, trust-first flows',
          role: 'Founding Product Designer · 2025',
          tag: 'FINTECH',
          year: '2025',
          desc: 'Fintech super app from scratch, trust-first flows',
        },
      ],
      [
        {
    ...
    moreProjects: [
      ...
      [
        ...
        },
        {
          ...
          alt: 'CueTV',
          name: 'CueTV',
          result: 'OTT platform and retargeting-system strategy',
          role: 'Product Designer · 2022',
          tag: 'PRODUCT DESIGN',
          year: '2022',
          desc: 'OTT platform and retargeting-system strategy',
        },
      ],
    ],
    approach: {
