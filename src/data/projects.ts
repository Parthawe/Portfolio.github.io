...
export const projects: Project[] = [
  ...
  },
  {
    ...
    cardMockup: '/Assets/Projects/MediMorpho/medimorpho-4x5.svg',
    cover16x9: '/Assets/Projects/MediMorpho/medimorpho-16x9.svg',
    cardMockupAlt: 'MediMorpho multilingual healthcare interpretation concept.',
    tag: 'HEALTHCARE UX',
    year: '2024',
    desc: 'A multilingual care concept helping patients with limited English proficiency understand medical language and next steps',
    category: 'good',
    ...
    access: {
      ...
      publicPreviewImage: '/Assets/Projects/MediMorpho/medimorpho-4x5.svg',
      publicPreviewAlt: 'MediMorpho multilingual healthcare interpretation concept.',
    },
    archiveOrder: 24,
    tier: 'b',
    ...
    summaryTeam: 'Five-person NYU student team · independent academic concept',
    ...
    summaryStats: [
      ...
      { label: 'Healthcare professionals', value: '4' },
      { label: 'Affinity themes', value: '4' },
    ],
    storyline: {
      challenge: 'Language barriers, medical jargon, and fragmented records can make a healthcare visit difficult to understand and even harder to remember.',
      approach: 'The team combined field interviews, secondary research, affinity mapping, journey mapping, and technical feasibility work to isolate the highest-risk communication moments.',
      result: 'MediMorpho became a service concept for making the conversation legible in the moment and the next step clear after the visit.',
    },
  },
  {
    slug: 'ibm',
