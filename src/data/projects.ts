...
export const projects: Project[] = [
  ...
  },
  {
    ...
    archiveOrder: 6,
    tier: 'a',
    summaryProblem: 'A large student conference needed a stage identity that could feel iconic in the room, photograph well, and coordinate a big volunteer build team.',
    summaryRole: 'Art director leading the visual concept, stage direction, production coordination, and execution across a 65-person team.',
    summaryTeam: '65-person student production and art team for TEDxVITPune.',
    summaryTimeline: '2021',
    ...
    storyline: {
      ...
      approach: 'I directed the visual system around layered cityscape forms, clear production roles, and a stage composition that worked both live and on camera.',
