...
export const projects: Project[] = [
  ...
  },
  {
    ...
    cardMockupAlt: 'NYU Langone Health building signage, the setting for an independent academic healthcare concept.',
    tag: 'HEALTHCARE UX',
    year: '2024',
    desc: 'An independent academic concept for clearer multilingual care, research, and follow-through',
    category: 'good',
    ...
    access: {
      ...
      publicPreviewAlt: 'NYU Langone Health building signage, the context for the MediMorpho academic concept.',
    },
    archiveOrder: 24,
    tier: 'b',
