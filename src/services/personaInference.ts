...
function getSignals(ctx: ChatContext): Signal[] {
  ...
  const CATEGORY_PATHS = new Set(['/', '/work', '/about', '/ai', '/ux-design', '/creative-tech', '/installations', '/brand-visual', '/fintech', '/design-for-good', '/crypto', '/ai-wearables', '/book', '/studio', '/graveyard'])
